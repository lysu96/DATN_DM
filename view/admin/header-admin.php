    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">Đăn xuất</a>
        </div>
      </li>
    </ul>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="index.php?hd=hinhanh">Ảnh</a>
          <a class="dropdown-item" href="index.php?hd=nguoidung">Người dùng</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?hd=bieudo">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Biểu đồ</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?hd=thongke">
